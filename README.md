...
You can create an SEC API key [here](https://sec-api.io/). Web search functionality uses OpenAI's Web Search API via the OPENAI_API_KEY.
...
- `google_web_search`: Search the web for information using OpenAI Web Search API
